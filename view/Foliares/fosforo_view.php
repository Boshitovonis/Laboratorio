...
<head>
    ...
    <title>Fósforo en Foliares</title>
        ...
        <form method="POST" action="">
            <div class="form-body">
                ...
                <div class="field-group">
                    <div class="field">
                        <label for="peso">Peso de Muestras (g)</label>
                        <input type="number" step="any" name="peso" id="peso" value="0.00" required>
                    </div>
                    <div class="field">
