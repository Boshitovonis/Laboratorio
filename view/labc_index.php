...
$suelosQuimicos = labc_visible_analysis([
    ...
    ['key' => 'suelos.nitrogeno', 'href' => 'controllers/Suelos/nitrogeno_controller.php', 'label' => 'Nitrogeno'],
    ...
    ['key' => 'suelos.fosforo', 'href' => 'controllers/Suelos/fosforo_controller.php', 'label' => 'Fosforo'],
]);
...
$foliares = labc_visible_analysis([
    ...
    ['key' => 'foliares.fosforo', 'href' => 'controllers/Foliares/fosforo_controller.php', 'label' => 'Fosforo'],
]);
...
$aguas = labc_visible_analysis([
    ...
    ['key' => 'aguas.fosforo', 'href' => 'controllers/Aguas/fosforo_controller.php', 'label' => 'Fosforo'],
    ['key' => 'aguas.conductividad', 'href' => 'controllers/Aguas/conductividad_controller.php', 'label' => 'Conductividad Electrica'],
    ...
    ['key' => 'aguas.alcanilidad', 'href' => 'controllers/Aguas/alcanilidad_controller.php', 'label' => 'Alcanilidad'],
...
$cana = labc_visible_analysis([
    ...
    ['key' => 'cana.brixpol', 'href' => 'controllers/Cana/brixpol_controller.php', 'label' => 'Determinacion de Brix y Pol'],
]);
...
<head>
    ...
    <title>Formularios de Analisis</title>
    ...
    <main class="page-wrap">
        <header class="doc-header">
            <div class="doc-header-left">
                ...
                <div>
                    <p class="doc-kicker">Laboratorio agricola</p>
                    <h1 class="doc-title">Formularios de analisis</h1>
                    <p class="doc-subtitle">Selecciona el modulo que deseas registrar o consultar.</p>
                </div>
            </div>
            ...
            <section class="form-section">
                ...
                <div class="card-grid">
                    ...
                    <?php if ($canConsolidacion): ?>
                        <a class="tarjeta" href="controllers/consolidacion_controller.php">Hoja de consolidacion</a>
                    <?php endif; ?>
                </div>
            </section>
        <?php endif; ?>
        ...
        <?php if (!empty($suelosFisicos) || !empty($suelosQuimicos) || $canCreateSolicitud): ?>
            <section class="form-section">
                ...
                <p class="subtitulo">Selecciona el analisis a registrar</p>
                ...
                <?php if (lab_can_analysis('suelos.boro') || lab_can_analysis('suelos.azufre') || lab_can_analysis('suelos.fosforo')): ?>
                    <div class="history-links">
                        ...
                        <?php if (lab_can_analysis('suelos.fosforo')): ?>
                            <a href="controllers/Suelos/historial_fosforo_controller.php">Ver historial de fosforo</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </section>
        ...
        <?php if (!empty($foliares)): ?>
            <section class="form-section">
                ...
                <?php if (lab_can_analysis('foliares.fosforo')): ?>
                    <div class="history-links">
                        <a href="controllers/Foliares/historial_fosforo_controller.php">Ver historial de fosforo</a>
                    </div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
        ...
        <?php if (!empty($aguas)): ?>
            <section class="form-section">
                ...
                <?php if (lab_can_analysis('aguas.fosforo')): ?>
                    <div class="history-links">
                        <a href="controllers/Aguas/historial_fosforo_controller.php">Ver historial de fosforo</a>
                    </div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
        ...
        <?php if (!empty($cana)): ?>
            <section class="form-section">
                <h2 class="section-title">Formularios de Cana</h2>
                <p class="subtitulo">Selecciona el analisis a registrar</p>
                <div class="card-grid">
        ...
        <?php if (!$canBlancoControl && !$canConsolidacion && empty($suelosFisicos) && empty($suelosQuimicos) && empty($foliares) && empty($aguas) && empty($cana)): ?>
            <section class="form-section">
                ...
                <p class="subtitulo">Tu usuario tiene acceso al modulo, pero no tiene permisos internos configurados para Laboratorio.</p>
            </section>
        <?php endif; ?>
    </main>
</body>
